...
class PixelVerse:
    ...
    async def stats(self):
        ...
        r = await (await self.session.get("https://api-clicker.pixelverse.xyz/api/points/burned-points/leaderboard")).json()
    ...
    async def claim_daily_combo(self):
        ...
        resp = await self.session.post(f"https://api-clicker.pixelverse.xyz/api/cypher-games/{combo_id}/answer", json=json_data)
    ...
    async def upgrade_pet(self):
        ...
        if balance >= expensive_pet[0]:
            ...
            resp = await self.session.post(f'https://api-clicker.pixelverse.xyz/api/pets/user-pets/{expensive_pet[1]}/level-up')
    ...
    async def select_pet(self):
        ...
        resp = await self.session.post(f"https://api-clicker.pixelverse.xyz/api/pets/user-pets/{expensive_pet}/select")
    ...
    async def login(self):
        ...
        self.session.headers['Secret'] = new("adwawdasfajfklasjglrejnoierjboivrevioreboidwa".encode(), user_id.encode(), sha256).hexdigest()
